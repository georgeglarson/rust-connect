...
public class LanLinkProvider extends BaseLinkProvider {
    ...
    public void sendUdpIdentityPacket(List<InetAddress> ipList, @Nullable Network network) {
        ...
        try {
            ...
            Log.e("LanLinkProvider", "Failed to serialize identity packet", e);
            return;
        }
        ...
        try {
            ...
            Log.e("LanLinkProvider", "Failed to create DatagramSocket", e);
            return;
        }
        ...
        for (InetAddress ip : ipList) {
            try {
                ...
                Log.e("LanLinkProvider", "Sending udp identity packet failed. Invalid address? (" + ip.toString() + ")", e);
            }
        }
