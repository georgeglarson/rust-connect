...
capabilities) sent every 5 s — inherent to the protocol.
...
- 512 KiB packet size cap (mirrors Android `LanLinkProvider`).
...
- 512 KiB packet cap and per-connection rate limits bound resource
  exhaustion.
