...
async fn start_discovery(
    ...
    // TODO(vk #993 follow-up): once mDNS is live-validated against the real
    // A15, revisit the UDP broadcast cadence (60s default today) — with
    // mDNS healthy it becomes a fallback, not the rediscovery path.
