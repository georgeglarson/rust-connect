...
//!
//! Interop with Conscrypt in both roles was proven live against a Galaxy A15
//! on 2026-07-29 by examples/tls_probe.rs; the verifier structure below is
//! the probe's, with accept-all swapped for the TOFU policy.
