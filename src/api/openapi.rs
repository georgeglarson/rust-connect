...
#[openapi(
    ...
    components(schemas(
        ...
        handlers::plugins::sftp::SftpRequestResponse,
        SftpRequestResponseWrapper,
        handlers::plugins::sftp::SftpInfoResponse,
        SftpInfoResponseWrapper,
        handlers::plugins::sftp::SftpMountResponse,
        SftpMountResponseWrapper,
        handlers::plugins::sftp::SftpUnmountResponse,
        SftpUnmountResponseWrapper,
        handlers::plugins::sms::SmsThreadsResponse,
        SmsThreadsResponseWrapper,
        handlers::plugins::sms::SmsThreadResponse,
        SmsThreadResponseWrapper,
        handlers::plugins::sms::SmsSentResponse,
        SmsSentResponseWrapper,
        crate::plugins::sms::SmsAddress,
        crate::plugins::sms::SmsMessage,
        crate::plugins::sms::SmsThread,
        handlers::plugins::mpris::MprisPlayersResponse,
        MprisPlayersResponseWrapper,
        handlers::plugins::mpris::MprisLocalPlayersResponse,
        MprisLocalPlayersResponseWrapper,
        handlers::plugins::mpris::MprisActionResponse,
        ...
        handlers::plugins::notification::NotificationsListResponse,
        NotificationsListResponseWrapper,
        handlers::plugins::notification::NotificationSentResponse,
        NotificationSentResponseWrapper,
        handlers::plugins::notification::NotificationReplyResponse,
        NotificationReplyResponseWrapper,
        handlers::plugins::notification::NotificationActionTriggeredResponse,
        NotificationActionTriggeredResponseWrapper,
        handlers::plugins::notification::NotificationDismissedResponse,
        NotificationDismissedResponseWrapper,
        crate::plugins::notification::NotificationEntry,
        handlers::plugins::lock::LockCommandSentResponse,
        LockCommandSentResponseWrapper,
        handlers::plugins::findmyphone::FindMyPhoneResponse,
        FindMyPhoneResponseWrapper,
        handlers::plugins::volume::VolumeControlSentResponse,
        VolumeControlSentResponseWrapper,
        handlers::share::ShareFilesResponse,
        ShareFilesResponseWrapper,
        handlers::share::SharedFile,
        handlers::share::ShareFileSentResponse,
        ShareFileSentResponseWrapper,
        handlers::share::ShareTextSentResponse,
        ShareTextSentResponseWrapper,
        handlers::share::ShareUrlSentResponse,
        ShareUrlSentResponseWrapper,
        handlers::plugins::clipboard::ClipboardContentResponse,
        ClipboardContentResponseWrapper,
        handlers::plugins::clipboard::ClipboardSetResponse,
        ClipboardSetResponseWrapper,
        handlers::plugins::clipboard::SetClipboardRequest,
        handlers::plugins::systemvolume::LocalSinkControlResponse,
        LocalSinkControlResponseWrapper,
        handlers::plugins::remotecontrol::PointerActionSentResponse,
        PointerActionSentResponseWrapper,
        handlers::plugins::remotekeyboard::KeypressSentResponse,
        KeypressSentResponseWrapper,
        handlers::PingSentResponse,
        PingSentResponseWrapper,
        handlers::DeviceRemovedResponse,
        DeviceRemovedResponseWrapper,
        handlers::ConnectDeviceRequest,
        handlers::DeviceConnectedResponse,
        DeviceConnectedResponseWrapper,
        handlers::DeviceDisconnectedResponse,
        DeviceDisconnectedResponseWrapper,
        handlers::DeviceStateResponse,
        DeviceStateResponseWrapper,
        handlers::ConnectedDeviceEntry,
        handlers::ConnectedDevicesResponse,
        ConnectedDevicesResponseWrapper,
    )),
