...
/// vk #968: pairing completion on an established connection must emit plugin
...
/// for the gate applying to every pair packet (vk #959).
#[tokio::test]
...
/// Parity gap 1 (docs/parity-checklist.md, vk #995): an unpaired peer's
